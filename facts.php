  ...
  <!--  <div class="img-holder">
    ...
    <div class="copy-block fade-child">
      ...
      <div class="copy">
        <p>
          ...
          50 feet of frontage across 8 stories, offering unlimited branding potential, this is an unprecedented “blank canvas” opportunity and available immediately.
</p>
    ...
    <ul class="no-style" id="fact-list">
      ...
      $factList = array(
        ...
        array('CENTRAL PARK ACCEE, <br/>YEARLY VISITORS','40 MILLION' ),
        array('BARNEY&rsquo;S + BERGDORF <br/>+ BLOOMINGDALES','CROSSROADS' ),
        array('TOP PHOTOGRAPHED RETAIL<br/> CORNER WORLDWIDE','NO.1' )
      );
